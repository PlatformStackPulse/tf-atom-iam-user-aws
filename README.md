...
[![CI](https://github.com/PlatformStackPulse/tf-atom-iam-user-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-iam-user-aws/actions/workflows/ci.yml)
[![Latest Release](https://img.shields.io/github/v/release/PlatformStackPulse/tf-atom-iam-user-aws)](https://github.com/PlatformStackPulse/tf-atom-iam-user-aws/releases)
...
Terraform atom: AWS IAM User - creates a single IAM user for service/machine access
...
| <a name="input_force_destroy"></a> [force\_destroy](#input\_force\_destroy) | Destroy user even if it has non-Terraform-managed access keys, login profile, or MFA devices | `bool` | `false` | no |
...
| <a name="output_user_arn"></a> [user\_arn](#output\_user\_arn) | ARN of the IAM user |
| <a name="output_user_name"></a> [user\_name](#output\_user\_name) | Name of the IAM user |
| <a name="output_user_unique_id"></a> [user\_unique\_id](#output\_user\_unique\_id) | Unique ID of the IAM user |
<!-- END_TF_DOCS -->
